...
int main() {
  ...
  python: {
    ...
    defaultCode: `# Welcome to CodeNest
print("Welcome to CodeNest!")`,
  ...
  javascript: {
    ...
    defaultCode: `// Welcome to CodeNest
console.log("Welcome to CodeNest!");`,
  },
  typescript: {
    id: "typescript",
    label: "TypeScript",
    ...
    defaultCode: `// Welcome to CodeNest
const message: string = "Welcome to CodeNest!";
console.log(message);`,
  },
...
func main() {
  fmt.Println("Welcome to CodeNest!")
}`,
  },
  rust: {
    id: "rust",
