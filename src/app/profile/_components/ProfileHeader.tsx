      ...
      <div className="relative flex flex-col sm:flex-row items-center sm:items-start gap-6 sm:gap-8">
        <div className="relative group w-24 h-24 shrink-0">
          ...
          <img
            ...
            className="w-24 h-24 rounded-full border-4 border-gray-800/50 relative z-10 group-hover:scale-105 transition-transform duration-300"
          />
          {userData.isPro && (
        ...
        {STATS.map((stat, index) => (
          ...
          >
            ...
            <div className="relative p-4 sm:p-6">
              ...
              {/* Metric */}
              <div className="flex items-center gap-2 pt-4 border-t border-gray-800/50 text-sm">
